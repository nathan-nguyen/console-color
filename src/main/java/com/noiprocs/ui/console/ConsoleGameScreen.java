...
public class ConsoleGameScreen implements GameScreenInterface {
  ...
  protected String getScreenContentInString(PlayerModel playerModel) {
    ...
    for (Model model : renderableModelList) {
      ...
      // Main player model position could be updated after offsetX and offsetY were calculated. If
      // we use normal
      // way to calculate sprite position, main player sprite might not be rendered in the middle of
      // screen
