...
public class WallTrapSprite extends ConsoleSprite {
    private static final char[][] TEXTURE_OPENED = new char[Config.MAZE_WALL_THICKNESS_HEIGHT][Config.MAZE_WALL_THICKNESS_WIDTH];
    private static final char[][] TEXTURE_CLOSED = new char[Config.MAZE_WALL_THICKNESS_HEIGHT][Config.MAZE_WALL_THICKNESS_WIDTH];
